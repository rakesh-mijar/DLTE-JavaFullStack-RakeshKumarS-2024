...
import static validation.ValidateInputs.isvalidatePhone;
import static validation.ValidateInputs.isvalidatePin;
    ...
    public void collectEmployeeDetails() throws SQLException {
        ...
        try {
            do {
                ...
                try {
                    URL url = new URL("http://localhost:8083/employees/writeData");
                    ...
                    if (responseCode == HttpURLConnection.HTTP_OK) {
                        ...
                        System.out.println(resourceBundle.getString("Fail.insert") + " " +empId+ " " + resourceBundle.getString("employee.exists"));
                    }
                }catch(IOException e) {
...
//                                }
    ...
    @Override
    public List<entities.EmployeeDetails> translateEntities(List<EmployeeDetails> backendEmployees) throws IOException {
        //method for translating the backend entities into console entities prior to display in console
        List<entities.EmployeeDetails> consoleEmployees = new ArrayList<>();
        ...
        try {
            for (EmployeeDetails backendEmployee : backendEmployees) {
                entities.EmployeeDetails consoleEmployee = new entities.EmployeeDetails();
                ...
                if (backendPermanentAddress != null) {
                    entities.EmployeeAddress consolePermanentAddress = new entities.EmployeeAddress();
                ...
                if (backendTemporaryAddress != null) {
                    entities.EmployeeAddress consoleTemporaryAddress = new entities.EmployeeAddress();
    ...
    @Override
    public void displayEmployeeDetails(List<entities.EmployeeDetails> consoleEmployees) {

        int counter = 0;
        for (entities.EmployeeDetails employee : consoleEmployees) {
            ...
            entities.EmployeeAddress permAddress = employee.getPermAddress();
            if (permAddress != null) {
            ...
            entities.EmployeeAddress tempAddress = employee.getTempAddress();
            if (tempAddress != null) {
