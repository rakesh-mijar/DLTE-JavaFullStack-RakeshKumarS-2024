 ...
 * 
 */
@WebServiceClient(name = "EmployeeSoapService", targetNamespace = "http://services.backend.org/", wsdlLocation = "http://localhost:1000/soap/dao?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EMPLOYEESOAPSERVICE_QNAME = new QName("http://services.backend.org/", "EmployeeSoapService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:1000/soap/dao?wsdl");
    ...
    public EmployeeSoap getEmployeeSoapPort() {
        return super.getPort(new QName("http://services.backend.org/", "EmployeeSoapPort"), EmployeeSoap.class);
    }
    ...
    public EmployeeSoap getEmployeeSoapPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.backend.org/", "EmployeeSoapPort"), EmployeeSoap.class, features);
    }
