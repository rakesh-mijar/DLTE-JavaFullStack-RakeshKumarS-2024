...
class BackendApplicationTests {
	...
	@Test
    //test case failed
    public void testfilterByStatus() throws CustomerNotFoundException {
    ...
    @Test
    //test case passed
    public void testfilterByStatus2() throws CustomerNotFoundException {
        List<Accounts> accountList = new ArrayList<>();
        Accounts account = new Accounts();
        account.setAccountId(1235456L);
        account.setCustomerId(1L);
    ...
    //test cae failed
    @Test
    public void testfilterByStatus3() throws CustomerNotFoundException {
        List<Accounts> accountList = new ArrayList<>();
        Accounts account = new Accounts();
        account.setAccountId(1235456L);
        account.setCustomerId(1L);
