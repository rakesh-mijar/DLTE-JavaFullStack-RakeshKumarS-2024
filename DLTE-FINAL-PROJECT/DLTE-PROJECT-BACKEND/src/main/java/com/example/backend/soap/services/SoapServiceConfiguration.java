...
public class SoapServiceConfiguration extends WsConfigurerAdapter {
    ...
    public ServletRegistrationBean servletRegistrationBean(ApplicationContext applicationContext){
        ...
        return new ServletRegistrationBean(servlet,"/accountsrepo/*");
    }
    //wsdl properties
    @Bean(name="accounts")
    public DefaultWsdl11Definition convertToWsdl1(XsdSchema xsdSchema) {
        DefaultWsdl11Definition defaultWsdl11Definition = new DefaultWsdl11Definition();
        defaultWsdl11Definition.setPortTypeName("AccountsPort");
        defaultWsdl11Definition.setTargetNamespace("http://accounts.services");
        defaultWsdl11Definition.setLocationUri("/accountsrepo");
